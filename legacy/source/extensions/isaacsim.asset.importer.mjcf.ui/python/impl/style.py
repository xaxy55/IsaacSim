...
"""Style definitions for MJCF importer UI widgets.

Re-exports :func:`~isaacsim.gui.components.style.get_style` and provides
the importer option panel style that references extension-local font assets.
"""
...
from isaacsim.gui.components.style import get_style as get_style  # noqa: F401
...
def get_option_style() -> dict:
    """Return the option panel UI style dictionary.

    Returns:
        UI style dictionary for option panels.

    Example:

    .. code-block:: python

        >>> from isaacsim.asset.importer.mjcf.ui.impl import style
        >>> isinstance(style.get_option_style(), dict)
        True
    """
    style = {
