...
/**
 * @brief Interface for wheeled robot OmniGraph nodes.
 *
 * This interface provides the foundation for wheeled robot OmniGraph nodes in Isaac Sim.
...
{
    CARB_PLUGIN_INTERFACE("isaacsim::robot::wheeled_robots::nodes", 1, 0);
};
