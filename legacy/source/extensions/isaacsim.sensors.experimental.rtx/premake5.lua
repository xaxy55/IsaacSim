...
repo_build.prebuild_link {
    ...
    { "python/impl", ext.target_dir .. "/isaacsim/sensors/experimental/rtx/impl" },
    { "python/tests", ext.target_dir .. "/isaacsim/sensors/experimental/rtx/tests" },
}

repo_build.prebuild_copy {
    { "python/*.py", ext.target_dir .. "/isaacsim/sensors/experimental/rtx" },
    {
        "%{root}/_build/target-deps/generic_model_output/%{platform}/%{config}/omni/sensors",
        ext.target_dir .. "/isaacsim/sensors/experimental/rtx"
    },
    {
